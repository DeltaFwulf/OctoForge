...
After the 1st and 2nd iterations were found to have their flaws i've decided to come back to you and talk through the design process to avoid any more errors. First of all the components. The MOSFET has been decided upon above. All that's left is: The MOSFET driver, the OpAmps, the NPN tranistor, the diode, and the various resistors and capacitors. For whatever reason, for v1 and v2, I decided that this board must be accomplished using surface mount components despite for the low number of components on a relatively large board. To makes for easier manufactoring and reproducability going back to basics and using through hole components is an all around better desision.

Along with this version is an updated circuitJS design MOSFET_OCT_V3

#### MOSFET - IPP016N06NF2SAKMA1

<https://uk.rs-online.com/web/p/mosfets/2601208P?gb=s>

#### MOSFET Driver - UCC27524P

<https://uk.rs-online.com/web/p/gate-drivers/8124303P>

#### OpAmp - LM258AP

<https://uk.rs-online.com/web/p/op-amps/6610502>
The LM258 is rated for sligthly higher temps than the more standard LM358 which I thought would be more fitting for use in a furnace. But a 358 could be used here probably just fine.

#### NPN Transistor - PN2222ATA

<https://uk.rs-online.com/web/p/bipolar-transistors/7390381>
The OpAmp driving the transistors base has a 4.7k resistor limiting current to 2.6mA. The transistor has to be able to handle 2.6 \* h<sub>fe</sub> mA of current. With a max h<sub>fe</sub> of 300 and a max current of 1A, the PN2222 is able to handle that.

#### Diode - 1N4004

<https://uk.rs-online.com/web/p/schottky-diodes-rectifiers/6289029?gb=s>
The 1N4004 is definetly overkill but it's what the simulation used.

#### Resistors and Capacitors

With the majority of the resistors in use on the circuit being used for measurements I've decided the error should be no more than 1%.
